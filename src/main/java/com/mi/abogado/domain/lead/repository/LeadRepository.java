package com.mi.abogado.domain.lead.repository;
...
public interface LeadRepository extends JpaRepository<Lead, UUID> {
    ...
    @Query(value = """
            select new com.mi.abogado.domain.lead.dto.LeadSummary(
    ...
    @Query("""
            select new com.mi.abogado.domain.lead.dto.LeadPipelineStage(le.status, count(le))
            from Lead le
            group by le.status
            """)
