package com.mi.abogado.domain.user.repository;
...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    @Query("""
            ...
            where u.tenant.id = :tenantId
              and u.status <> com.mi.abogado.domain.user.entity.UserStatus.DISABLED
              and u.role <> com.mi.abogado.domain.user.entity.Role.CLIENT
            """)
     ...
     */
    @Query(value = """
            select new com.mi.abogado.domain.user.dto.MemberSummary(
