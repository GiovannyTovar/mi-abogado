package com.miabogado.domain.appointment.repository;
...
public interface AppointmentRepository extends JpaRepository<Appointment, UUID> {
    ...
    @Query("""
            ...
            where a.lawyer.id = :lawyerId
              and a.status in (com.miabogado.domain.appointment.entity.AppointmentStatus.SCHEDULED,
                               com.miabogado.domain.appointment.entity.AppointmentStatus.CONFIRMED)
